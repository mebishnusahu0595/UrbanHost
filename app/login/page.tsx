              ...
              {step === 0 && (
                <>
                  ...
                  <button
                    ...
                    className="w-full h-14 rounded-xl text-base font-bold border border-gray-300 bg-white hover:bg-gray-50 active:bg-gray-100 text-gray-800 hover:text-gray-900 cursor-pointer flex items-center justify-center transition-colors duration-150 shadow-sm"
                  >
        ...
        <div className="relative z-10 w-full flex items-center justify-center p-20">
          <div className="max-w-md text-white space-y-10">
            ...
            <div className="flex items-center gap-4 p-4 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 italic text-blue-50 text-sm">
              ...
              "StayNTour doubled my occupancy rate in 3 months!"
            </div>
          </div>
        </div>
      </div>
